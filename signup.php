        ...
        <div class="container">
            <form action="process-signup.php" method="post">
                ...
                <div class="container row">
                    <div style="padding: 0px" class="col-md-6">
                        <div class="form-floating">
                            <input type="text" name="txtHo" class="form-control" id="floatingInput" placeholder="firstname" require autofocus>
                            <label for="floatingInput">Họ</label>
                        </div>
                    </div>
                    <div style="padding-right: 0px" class="col-md-6">
                        <div class="form-floating">
                            <input type="text" name="txtTen" class="form-control" id="floatingInput" placeholder="name" require autofocus>
                            <label for="floatingInput">Tên</label>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 20px" class="form-floating">
                    <input type="email" name="txtgmail" class="form-control" id="floatingInput" placeholder="gmail" require autofocus>
                ...
                <div style="padding-top: 20px;" class="pass container row">
                    <div style="padding: 0px" class="col-md-6">
                        <div class="form-floating">
                            <input type="password" name="txtpass1" class="form-control" id="pass" placeholder="matkhau" require>
                            <label for="InputPassword">Mật khẩu</label>
                        </div>
                    </div>
                    <div style="padding-right: 0px" class="col-md-6">
                        <div class="form-floating">
                            <input type="password" name="txtpass2" class="form-control" id="pass" placeholder="xacnhan" require>
                            <label for="RetypeInputPassword">Xác nhận</label>
                        </div>
                    </div>
                ...
                <div class="tao col-md-6 mb-5">
                    <button type="submit" name="btnSignup" class="bnt" style="background-color: dodgerblue;"> <span style="color:aliceblue;">Đăng kí</span></button>
                </div>
        </div>
        </form>
        </div>
